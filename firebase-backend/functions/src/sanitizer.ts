 ...
 * @return {string}
 */
function replaceSwearwords(message: any) {
 ...
 * @return {boolean}
 */
function isShouting(message: { replace: (arg0: RegExp, arg1: string) => { (): any; new(): any; length: number; }; length: number; }) {
